...
langs.forEach((lang) => {
  ...
  baseKeys.forEach((key) => {
    ...
    const clientContent = `export const ${genericFunctionName} = ${JSON.stringify(value)}`
    fs.writeFileSync(path.join(clientOutputDir, lang, `${genericFunctionName}.tsx`), clientContent)
